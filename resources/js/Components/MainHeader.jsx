            ...
            <nav className="mx-auto flex container items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="#" className="-m-1.5 p-1.5">
                        ...
                        <img className="h-12 w-auto" src="assets/img/logo.svg" alt="" />
                    </a>
                </div>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-8">
                    <Link href={route('login')} className="flex items-center text-sm font-semibold leading-6 text-gray-900">
                        <UserCircleIcon className="h-4 me-1" />
                        Sign in
                    </Link>
                    <a href="#" className="flex items-center text-sm font-semibold leading-6 text-gray-900">
                        <ShoppingCartIcon className="h-4 me-1" />
                        Cart
                    </a>
                </div>
            </nav>
